...
const ISLAND_CONTINUATION_BOUNDARY_CLEARANCE_PT = 2
...
function resolveDraftIslandSurfaceChromeHeightPt(sourceFragment: PageFragment, draftFragment: PageFragment): number {
